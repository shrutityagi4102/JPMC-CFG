        ...
        <div className="header">
            <div className="header-left">
                <a href="index.html" className="logo">
                    <img src="../../public/logo.png" width="35" height="35" alt="" /> <span>St. Jude India</span>
                </a>
            </div>
                ...
                <li className="nav-item dropdown has-arrow">
                    <a href="index.html" className="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                        <span className="user-img">
							<img className="rounded-circle" src="../../public/assets/img/user.jpg" width="24" alt="Admin" />
            ...
            <div className="sidebar-inner slimscroll ">
                <div id="sidebar-menu " className="sidebar-menu ">
                    <ul>
                        ...
                        <li>
                            <a href="index.html"><i className="fa fa-user-md "></i> <span>Patient Registration</span></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="index.html"><i className="fa fa-bar-chart "></i> <span>Stastics & Visualisation</span></a>
                        </li>
                    </ul>
                </div>
            </div>
